    ...
    return (
        <div className='h-screen w-full'>
            ...
            <div className='md:flex p-4 space-y-[5vh] sm:space-x-8 lg:space-x-15 xl:space-x-20 justify-center overflow-x-auto'>
                <Course_card id='1' className = "pb-5 md:pb-0" imgSrc='./src/assets/AI.png' name='Artificial Intelligence' description='The best AI course for beginners.' rating={4.9}/>
                <Course_card id='2' className = "pb-5 md:pb-0" imgSrc='./src/assets/Py.png' name='Programming in Python' description='Learn Python from scratch.' rating={5}/>
