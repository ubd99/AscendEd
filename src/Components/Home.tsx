    ...
    return (
        <div className='h-screen w-full'>
            ...
            <div className='bg-blue-700 h-80 xl:h-120 relative'>
                <img src='./src/assets/Home.png' className="absolute sm:w-[300px] md:w-[350px] lg:w-[400px] xl:w-[500px] h-[180px] sm:h-[200px] md:h-[240px] xl:h-[350px] right-1 md:right-7 lg:right-20 top-13 md:top-10 object-cover rounded-md"></img>
