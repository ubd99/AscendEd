...
const About = () =>{
    return(
        <div>
            <Navbar/>
            <div className='bg-purple-950 shadow-black h-90 sm:h-100 shadow-md md:h-120 lg:h-135 xl:h-105 relative'>
            ...
            <div className="bg-purple-950 w-full h-120 text-center">
                <div>
                    <img src="./src/assets/plan.png" className="w-[calc(15vw+15vh)] mx-auto pt-10"></img>
                    <p className="font-bold text-md pt-10">Easy and Affordable Plans</p>
                    <p className="text-md p-5">Whether you’re just starting out or growing fast, our plans keep things affordable.</p>
                </div>
            </div>
        </div>
    )
