        ...
        <div className='w-full'>
            ...
            <div className='sm:flex sm:px-[calc(5vw+5vh)]'>
                ...
                <div className='pt-10 sm:w-1/2'>
                    <p className='pb-10 text-center font-semibold sm:text-left text-base xl:pl-8 headertext font-opensans'>Future-Proof your skills with the perfect courses</p>
            ...
            <p className='p-5 text-center text-base font-semibold xl:pl-8 sm:text-lg md:text-xl lg:text-2xl xl:text-4xl font-opensans'>Don't take our word for it. See for yourself</p>
